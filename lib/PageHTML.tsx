...
const LOGO_CSS = `.site-logo{height:auto;max-width:100%;object-fit:contain}.site-logo--header{height:clamp(28px,4vw,40px);width:auto}.site-logo--footer{height:clamp(32px,4.5vw,48px);width:auto}`;
